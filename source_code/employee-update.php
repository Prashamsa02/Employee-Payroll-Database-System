...
<nav class="w3-sidebar w3-light-blue w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <dt><a href="department.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Department</a> </dt>
          <dd></dd>
    <dt><a href="employee.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white   w3-white">  Employee  </a></dt>
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container " style="font-size: 50px;color:#f5f5dc">
          <img src="images/h10.jpg" alt="Lights" style="width:100%" style="height: 150px">
      ...
      <form class="w3-container" action="em-updatephp.php" method="post">
          ...
          <p><label>Bank Account No</label>
           ...
           <p><label>Manager id</label>
                     ...
                     <input type="submit" value="Update" class="w3-input w3-pink w3-round-xxlarge w3-animate-input w3-hover-blue">
